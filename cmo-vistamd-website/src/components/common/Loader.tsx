    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Cœur cardiaque animé avec pulsation ECG */}
          <div style={{
            position: 'absolute',
            bottom: '-10px',
            right: '-10px',
            ...
            {/* Cœur SVG animé - Rouge */}
            <svg fill="#ef4444" version="1.1" viewBox="0 0 24 24" width="40" height="40" style={{
	...
	l-1.7,2.6C11.6,13.8,11.3,14,11,14z"/>
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            <span style={{ animation: 'char-appear 0.05s ease-out forwards, char-pop 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) forwards', animationDelay: '1.85s', display: 'inline-block', transformStyle: 'preserve-3d' }}>O_</span>
            <span style={{
               color: '#047B30FF',
