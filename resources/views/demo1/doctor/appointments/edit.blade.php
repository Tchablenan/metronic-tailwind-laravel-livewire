            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="status" id="status" required
                        ...
                        <option value="in_progress" {{ old('status', $appointment->status) == 'in_progress' ? 'selected' : '' }}>En cours</option>
                ...
                <div class="lg:col-span-2">
                    ...
                    <textarea name="notes"
                              id="notes"
                              rows="3"
                              placeholder="Notes privées pour le personnel médical..."
                ...
                @if(auth()->user()->role === 'doctor')
                <div class="lg:col-span-2" id="cancellation-reason-field" style="display: {{ old('status', $appointment->status) == 'cancelled' ? 'block' : 'none' }};">
