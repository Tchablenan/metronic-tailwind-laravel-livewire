                ...
                <div class="p-7">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">Durée : {{ $appointment->duration }} minutes</p>
                        </div>
                    </div>

                    <div class=" pt-6 mb-6"></div>

                    <!-- Type et Lieu -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Type</label>
                            @php
                            $typeColors = [
                    ...
                    <div class=" pt-6 mb-6">
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Prix</label>
                        <p class="text-2xl font-bold text-blue-600">{{ number_format($appointment->price, 0, ',', ' ') }} FCFA</p>
                    </div>
                    @endif
                    ...
                    <div class="mb-6">
                        <div class="flex items-center gap-3 px-4 py-3 bg-red-50 border-l-4 border-red-500 rounded-lg">
                            ...
                            <span class="text-sm font-semibold text-red-800">Rendez-vous urgent</span>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="border-t border-gray-100 pt-6 mb-6">
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Motif de consultation</label>
                    ...
                    <div class="border-t border-gray-100 pt-6 mb-6">
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Remarques pour le patient</label>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-xl shadow-md">
                ...
                <div class="p-7 space-y-3">
                    ...
                    <!-- Rappeler le patient -->
                    <a href="tel:{{ $appointment->patient->phone_number }}"
                       class="flex items-center gap-3 w-full px-5 py-3.5 text-sm font-medium text-purple-700 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
            ...
            <div class="bg-white rounded-xl shadow-md">
                ...
                <div class="p-7 space-y-5">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-900 text-base mb-1">{{ $appointment->patient->full_name }}</h4>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-3 text-sm">
                            ...
                            <a href="tel:{{ $appointment->patient->phone_number }}" class="text-blue-600 hover:underline">
