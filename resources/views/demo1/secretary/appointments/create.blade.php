...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex items-center gap-4 pb-8">
        ...
        <div class="flex flex-col gap-1">
            ...
            <p class="text-sm text-gray-600">
                Enregistrer un nouveau rendez-vous pour un patient
            </p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md">
        <form method="POST" action="{{ route('appointments.store') }}" class="p-7">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="lg:col-span-2">
                    ...
                    <textarea name="patient_notes"
                              ...
                              class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none @error('patient_notes') border-red-500 @enderror">{{ old('patient_notes') }}</textarea>
                    @error('patient_notes')
                        <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                    @enderror
                </div>
